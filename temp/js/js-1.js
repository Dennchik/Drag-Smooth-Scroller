...
let dragRatio = 400; // Увеличенное значение для уменьшения требуемого движения мыши
let scrollTo;
...
let scrollTween = gsap.to(sections, {
	...
	scrollTrigger: {
		...
		onRefresh: (self) => {
			dragRatio =
				(self.end - self.start) /
				((sections.length - 1) * sections[0].offsetWidth) * 400; // Измененное значение
		},
